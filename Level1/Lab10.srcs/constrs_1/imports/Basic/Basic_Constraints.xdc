...
## Switches
set_property PACKAGE_PIN V17 [get_ports {Reg_Sel[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Reg_Sel[0]}]
set_property PACKAGE_PIN V16 [get_ports {Reg_Sel[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Reg_Sel[1]}]
set_property PACKAGE_PIN W16 [get_ports {Reg_Sel[2]}]
...
set_property PACKAGE_PIN R2 [get_ports {Type_Sel}]
	set_property IOSTANDARD LVCMOS33 [get_ports {Type_Sel}]
